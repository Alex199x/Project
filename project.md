-   [Third, to each egocentric sample we will fit an egocentric ERGM
    ...
    ## 
    ## 'ergm' 4.0-6403 (2021-06-10), part of the Statnet Project
    ...
    ## 
    ## 'ergm.ego' 0.9-602 (2021-05-28), part of the Statnet Project
...
\#First fit an ERGM to the complete network
    ...
    ## The log-likelihood improved by 1.254.
    ...
    ## The log-likelihood improved by 1.149.

    ## Iteration 6 of at most 60:

    ## Convergence test P-value:9.5e-228

    ## The log-likelihood improved by 0.9787.

    ## Iteration 7 of at most 60:

    ## Convergence test P-value:1.9e-78

    ## The log-likelihood improved by 0.2858.

    ## Iteration 8 of at most 60:

    ## Convergence test P-value:3.9e-61

    ## The log-likelihood improved by 0.1288.

    ## Iteration 9 of at most 60:

    ## Convergence test P-value:1.2e-30

    ## The log-likelihood improved by 0.06144.

    ## Iteration 10 of at most 60:

    ## Convergence test P-value:8.2e-28

    ## The log-likelihood improved by 0.05124.

    ## Iteration 11 of at most 60:

    ## Convergence test P-value:3.4e-15

    ## The log-likelihood improved by 0.02954.

    ## Iteration 12 of at most 60:

    ## Convergence test P-value:3.6e-21

    ## The log-likelihood improved by 0.03752.

    ## Iteration 13 of at most 60:

    ## Convergence test P-value:3e-07

    ## The log-likelihood improved by 0.01694.

    ## Iteration 14 of at most 60:

    ## Convergence test P-value:9e-04
    ...
    ## The log-likelihood improved by 0.005474.

    ## Iteration 16 of at most 60:

    ## Convergence test P-value:3.3e-08

    ## The log-likelihood improved by 0.01883.

    ## Iteration 17 of at most 60:

    ## Convergence test P-value:8.9e-03

    ## The log-likelihood improved by 0.008407.

    ## Iteration 18 of at most 60:

    ## Convergence test P-value:1.4e-02

    ## The log-likelihood improved by 0.008181.

    ## Iteration 19 of at most 60:

    ## Convergence test P-value:2.6e-03

    ## The log-likelihood improved by 0.009328.

    ## Iteration 20 of at most 60:

    ## Convergence test P-value:8e-05
    ...
    ## The log-likelihood improved by 0.008662.

    ## Iteration 22 of at most 60:

    ## Convergence test P-value:5.4e-01

    ## Convergence detected. Stopping.

    ## The log-likelihood improved by 0.00322.
    ...
    ##     nodeocov("Age") + nodeicov("Age"), constraints = ~bd(maxout = 6) + 
    ##     blocks(~Age %in% 32 - 49, levels2 = 3), target.stats = c(uc.edges, 
    ...
    ## edges                        7.519e+00  5.883e-01      0   12.78   <1e-04 ***
    ## nodeifactor.GENDER.2        -3.654e+00  1.503e-01      0  -24.31   <1e-04 ***
    ## mutual                       3.015e+01  2.803e-01      0  107.55   <1e-04 ***
    ## F(diff("Age"))~edges        -4.868e+01  4.775e-01     15 -101.94   <1e-04 ***
    ## F(diff("Age"))~nodeocov.Age  5.366e+08         NA     NA      NA       NA    
    ## F(diff("Age"))~nodeicov.Age -5.366e+08         NA     NA      NA       NA    
    ## nodeocov.Age                -5.366e+08         NA     NA      NA       NA    
    ## nodeicov.Age                 5.366e+08         NA     NA      NA       NA    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ##      Null Deviance: 0.000e+00  on 1332870  degrees of freedom
    ##  Residual Deviance: 5.196e+13  on 1332862  degrees of freedom
    ##  
    ...
    ## 
    ## AIC: 5.196e+13  BIC: 5.196e+13  (Smaller is better. MC Std. Err. = 140.6)
...
====================================================================================================================
    ...
    ## offset(edges)                 -6.3099     0.0000      0    -Inf   <1e-04 ***
    ## offset(mutual)                 6.3099     0.0000      0     Inf   <1e-04 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
