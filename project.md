...
\#First fit an ERGM to the complete network
    ...
    odegree2<-sum(table(out.row$PRIM_KEY)==2)
    ...
    ## The log-likelihood improved by 0.3497.
    ...
    ## Convergence test p-value: 0.0077. Converged with 99% confidence.
    ## Finished MCMLE.
    ...
    ##     nodeofactor("GENDER") + offset(edges), offset.coef = c(-log(1155)), 
    ##     target.stats = c(uc.edges, nodeifactor.male, nodeofactor.male))
    ## 
    ## Monte Carlo Maximum Likelihood Results:
    ## 
    ##                      Estimate Std. Error MCMC % z value Pr(>|z|)    
    ## edges                 3.31420    0.01584      0  209.21   <1e-04 ***
    ## nodeifactor.GENDER.2 -1.35699    0.02596      0  -52.27   <1e-04 ***
    ## nodeofactor.GENDER.2 -1.36203    0.02464      0  -55.29   <1e-04 ***
    ## edges.1              -7.05186    0.00000      0    -Inf   <1e-04 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ##      Null Deviance:  1847750  on 1332870  degrees of freedom
    ##  Residual Deviance: -6936354  on 1332866  degrees of freedom
    ##  
    ## AIC: -6936348  BIC: -6936312  (Smaller is better. MC Std. Err. = 187.8)
    ## 
...
![](project_files/figure-markdown_strict/unnamed-chunk-11-1.png)![](project_files/figure-markdown_strict/unnamed-chunk-11-2.png)![](project_files/figure-markdown_strict/unnamed-chunk-11-3.png)![](project_files/figure-markdown_strict/unnamed-chunk-11-4.png)![](project_files/figure-markdown_strict/unnamed-chunk-11-5.png)
    ...
    fit.02<-ergm(ucnet.network~
                     ...
                     target.stats=c(uc.edges,nodeifactor.male,nodeofactor.male,f.edges,f.nodeocov,f.nodeicov,nodeocov,nodeicov),
                     )
    ...
    ## Optimizing with step length 0.0163.

    ## The log-likelihood improved by 1.5761.

    ## Estimating equations are not within tolerance region.

    ## Iteration 2 of at most 60:

    ## Optimizing with step length 0.0185.

    ## The log-likelihood improved by 2.0127.
    ...
    ## The log-likelihood improved by 1.8842.
    ...
    ## Optimizing with step length 0.0184.

    ## The log-likelihood improved by 2.2636.
    ...
    ## The log-likelihood improved by 2.1469.
    ...
    ## The log-likelihood improved by 1.7100.
    ...
    ## The log-likelihood improved by 2.0358.
    ...
    ## The log-likelihood improved by 1.9504.
    ...
    ## The log-likelihood improved by 2.3029.
    ...
    ## The log-likelihood improved by 2.3555.
    ...
    ## The log-likelihood improved by 2.2098.
    ...
    ## The log-likelihood improved by 1.8138.
    ...
    ## The log-likelihood improved by 1.8955.

    ## Estimating equations are not within tolerance region.

    ## Iteration 16 of at most 60:

    ## Optimizing with step length 0.0123.

    ## The log-likelihood improved by 1.2578.

    ## Estimating equations are not within tolerance region.

    ## Iteration 17 of at most 60:

    ## Optimizing with step length 0.0153.

    ## The log-likelihood improved by 1.6750.
    ...
    ## The log-likelihood improved by 1.9793.
    ...
    ## The log-likelihood improved by 1.8538.
    ...
    ## The log-likelihood improved by 1.9739.
    ...
    ## The log-likelihood improved by 1.6675.
    ...
    ## The log-likelihood improved by 1.2821.
    ...
    ## The log-likelihood improved by 1.4110.

    ## Estimating equations are not within tolerance region.

    ## Iteration 24 of at most 60:

    ## Optimizing with step length 0.0152.

    ## The log-likelihood improved by 1.8473.
    ...
    ## The log-likelihood improved by 2.0569.
    ...
    ## The log-likelihood improved by 1.3409.
    ...
    ## The log-likelihood improved by 2.0667.
    ...
    ## The log-likelihood improved by 2.0138.
    ...
    ## The log-likelihood improved by 1.5799.
    ...
    ## The log-likelihood improved by 1.3734.
    ...
    ## The log-likelihood improved by 2.4331.
    ...
    ## The log-likelihood improved by 1.9255.
    ...
    ## The log-likelihood improved by 1.7433.
    ...
    ## The log-likelihood improved by 2.1906.
    ...
    ## The log-likelihood improved by 1.4367.
    ...
    ## The log-likelihood improved by 1.5788.
    ...
    ## The log-likelihood improved by 1.6165.
    ...
    ## The log-likelihood improved by 1.3983.
    ...
    ## The log-likelihood improved by 2.1808.
    ...
    ## The log-likelihood improved by 1.7174.
    ...
    ## The log-likelihood improved by 2.3978.
    ...
    ## The log-likelihood improved by 1.4638.
    ...
    ## The log-likelihood improved by 1.9034.
    ...
    ## The log-likelihood improved by 2.4103.
    ...
    ## The log-likelihood improved by 2.1229.
    ...
    ## The log-likelihood improved by 1.7462.
    ...
    ## The log-likelihood improved by 2.1094.
    ...
    ## The log-likelihood improved by 2.4075.
    ...
    ## The log-likelihood improved by 2.2539.
    ...
    ## The log-likelihood improved by 2.1789.
    ...
    ## The log-likelihood improved by 1.5437.
    ...
    ## The log-likelihood improved by 1.8377.
    ...
    ## The log-likelihood improved by 1.5287.
    ...
    ## The log-likelihood improved by 1.8964.
    ...
    ## The log-likelihood improved by 1.8344.
    ...
    ## The log-likelihood improved by 1.8127.
    ...
    ## The log-likelihood improved by 1.8634.

    ## Estimating equations are not within tolerance region.

    ## Iteration 59 of at most 60:

    ## Optimizing with step length 0.0183.

    ## The log-likelihood improved by 2.3651.
    ...
    ## The log-likelihood improved by 3.0523.
    ...
    ## Call:
    ## ergm(formula = ucnet.network ~ edges + nodeifactor("GENDER") + 
    ##     nodeofactor("GENDER") + F(~edges + nodeocov("Age") + nodeicov("Age"), 
    ##     ~diff("Age") > 6) + nodeocov("Age") + nodeicov("Age") + offset(edges), 
    ##     offset.coef = c(-log(1155)), target.stats = c(uc.edges, nodeifactor.male, 
    ##         nodeofactor.male, f.edges, f.nodeocov, f.nodeicov, nodeocov, 
    ##         nodeicov))
    ## 
    ## Monte Carlo Maximum Likelihood Results:
    ## 
    ##                                Estimate Std. Error MCMC % z value Pr(>|z|)    
    ## edges                          8.528123   0.161433      0   52.83   <1e-04 ***
    ## nodeifactor.GENDER.2          -1.474065   0.043332      0  -34.02   <1e-04 ***
    ## nodeofactor.GENDER.2          -1.364711   0.043135      0  -31.64   <1e-04 ***
    ## F.diff..Age...6..edges        -6.322370   0.528656      0  -11.96   <1e-04 ***
    ## F.diff..Age...6..nodeocov.Age -0.360135   0.014295      0  -25.19   <1e-04 ***
    ## F.diff..Age...6..nodeicov.Age  0.489359   0.012223      0   40.04   <1e-04 ***
    ## nodeocov.Age                   0.346744   0.009510      0   36.46   <1e-04 ***
    ## nodeicov.Age                  -0.492299   0.008674      0  -56.75   <1e-04 ***
    ## edges.1                       -7.051856   0.000000      0    -Inf   <1e-04 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ##      Null Deviance:   1847750  on 1332870  degrees of freedom
    ##  Residual Deviance: -20685454  on 1332861  degrees of freedom
    ##  
    ## AIC: -20685438  BIC: -20685341  (Smaller is better. MC Std. Err. = 191)
    ## 
    ##  The following terms are fixed by offset and are not estimated:
    ##   edges.1
...
![](project_files/figure-markdown_strict/unnamed-chunk-12-1.png)![](project_files/figure-markdown_strict/unnamed-chunk-12-2.png)![](project_files/figure-markdown_strict/unnamed-chunk-12-3.png)![](project_files/figure-markdown_strict/unnamed-chunk-12-4.png)![](project_files/figure-markdown_strict/unnamed-chunk-12-5.png)

    fit.03<-ergm(ucnet.network~
                       edges+nodeifactor('GENDER')+nodeofactor('GENDER') +mutual
                     ...
                     offset.coef = c(-log(1155),log(1155)),

                     target.stats=c(uc.edges,nodeifactor.male,nodeofactor.male,Reciprocal,f.edges,f.nodeocov,f.nodeicov,nodeocov,nodeicov),
                     )
    ...
    ## The log-likelihood improved by 1.9914.

    ## Estimating equations are not within tolerance region.

    ## Iteration 2 of at most 60:

    ## Optimizing with step length 0.0124.

    ## The log-likelihood improved by 1.6227.
    ...
    ## The log-likelihood improved by 1.5236.
    ...
    ## The log-likelihood improved by 2.1312.
    ...
    ## The log-likelihood improved by 1.9864.
    ...
    ## The log-likelihood improved by 1.6363.
    ...
    ## The log-likelihood improved by 2.1324.
    ...
    ## The log-likelihood improved by 2.1607.
    ...
    ## The log-likelihood improved by 1.5846.
    ...
    ## The log-likelihood improved by 2.0531.
    ...
    ## The log-likelihood improved by 1.6885.
    ...
    ## The log-likelihood improved by 1.6811.
    ...
    ## The log-likelihood improved by 1.5926.
    ...
    ## The log-likelihood improved by 1.7063.
    ...
    ## The log-likelihood improved by 1.9886.
    ...
    ## The log-likelihood improved by 2.4984.
    ...
    ## The log-likelihood improved by 1.6584.
    ...
    ## The log-likelihood improved by 1.6880.
    ...
    ## The log-likelihood improved by 1.9994.
    ...
    ## The log-likelihood improved by 2.1238.
    ...
    ## The log-likelihood improved by 2.0482.
    ...
    ## The log-likelihood improved by 2.5181.
    ...
    ## The log-likelihood improved by 1.7140.
    ...
    ## The log-likelihood improved by 1.9659.
    ...
    ## The log-likelihood improved by 1.2328.

    ## Estimating equations are not within tolerance region.

    ## Iteration 26 of at most 60:

    ## Optimizing with step length 0.0121.

    ## The log-likelihood improved by 2.0770.
    ...
    ## The log-likelihood improved by 1.6077.
    ...
    ## The log-likelihood improved by 2.0399.
    ...
    ## The log-likelihood improved by 1.9545.
    ...
    ## The log-likelihood improved by 1.6306.
    ...
    ## The log-likelihood improved by 1.2704.

    ## Estimating equations are not within tolerance region.

    ## Iteration 32 of at most 60:

    ## Optimizing with step length 0.0106.

    ## The log-likelihood improved by 1.9181.
    ...
    ## The log-likelihood improved by 2.5755.
    ...
    ## The log-likelihood improved by 1.7281.
    ...
    ## The log-likelihood improved by 2.3753.
    ...
    ## The log-likelihood improved by 2.1763.
    ...
    ## The log-likelihood improved by 2.1443.
    ...
    ## The log-likelihood improved by 2.3811.
    ...
    ## The log-likelihood improved by 2.5558.
    ...
    ## The log-likelihood improved by 2.2813.
    ...
    ## The log-likelihood improved by 1.4431.
    ...
    ## The log-likelihood improved by 1.7378.
    ...
    ## The log-likelihood improved by 1.5933.
    ...
    ## The log-likelihood improved by 1.9343.
    ...
    ## The log-likelihood improved by 2.3889.
    ...
    ## The log-likelihood improved by 1.4092.
    ...
    ## The log-likelihood improved by 2.4080.
    ...
    ## The log-likelihood improved by 2.1291.
    ...
    ## The log-likelihood improved by 2.1931.
    ...
    ## The log-likelihood improved by 1.5141.
    ...
    ## The log-likelihood improved by 1.5653.
    ...
    ## The log-likelihood improved by 1.6544.
    ...
    ## The log-likelihood improved by 2.9412.
    ...
    ## The log-likelihood improved by 2.2587.
    ...
    ## The log-likelihood improved by 2.2008.
    ...
    ## The log-likelihood improved by 2.2825.
    ...
    ## The log-likelihood improved by 1.4028.
    ...
    ## The log-likelihood improved by 1.6723.
    ...
    ## The log-likelihood improved by 1.9295.
    ...
    ## The log-likelihood improved by 2.2888.
    ...
    ## Call:
    ## ergm(formula = ucnet.network ~ edges + nodeifactor("GENDER") + 
    ##     nodeofactor("GENDER") + mutual + F(~edges + nodeocov("Age") + 
    ##     nodeicov("Age"), ~diff("Age") > 6) + nodeocov("Age") + nodeicov("Age") + 
    ##     offset(edges) + offset(mutual), offset.coef = c(-log(1155), 
    ##     log(1155)), target.stats = c(uc.edges, nodeifactor.male, 
    ...
    ## 
    ##                                Estimate Std. Error MCMC % z value Pr(>|z|)    
    ## edges                          7.119176   0.100315      0   70.97   <1e-04 ***
    ## nodeifactor.GENDER.2          -1.121228   0.028501      0  -39.34   <1e-04 ***
    ## nodeofactor.GENDER.2          -1.031710   0.018808      1  -54.85   <1e-04 ***
    ## mutual                        -2.874259   0.095903      0  -29.97   <1e-04 ***
    ## F.diff..Age...6..edges        -3.665423   0.306947      0  -11.94   <1e-04 ***
    ## F.diff..Age...6..nodeocov.Age -0.474728   0.011699      0  -40.58   <1e-04 ***
    ## F.diff..Age...6..nodeicov.Age  0.576193   0.009700      0   59.40   <1e-04 ***
    ## nodeocov.Age                   0.433964   0.007519      0   57.72   <1e-04 ***
    ## nodeicov.Age                  -0.563422   0.007907      0  -71.25   <1e-04 ***
    ## edges.1                       -7.051856   0.000000      0    -Inf   <1e-04 ***
    ## mutual.1                       7.051856   0.000000      0     Inf   <1e-04 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ##      Null Deviance:   1847750  on 1332870  degrees of freedom
    ##  Residual Deviance: -16971310  on 1332859  degrees of freedom
    ##  
    ## AIC: -16971292  BIC: -16971184  (Smaller is better. MC Std. Err. = 188.1)
    ## 
    ##  The following terms are fixed by offset and are not estimated:
    ##   edges.1 mutual.1
...
![](project_files/figure-markdown_strict/unnamed-chunk-13-1.png)![](project_files/figure-markdown_strict/unnamed-chunk-13-2.png)![](project_files/figure-markdown_strict/unnamed-chunk-13-3.png)![](project_files/figure-markdown_strict/unnamed-chunk-13-4.png)![](project_files/figure-markdown_strict/unnamed-chunk-13-5.png)
    ...
    #degree
    sample.idegree0<-(nrow(sample.alter)-nrow(sample.out.row))+(nrow(sample.ego)-nrow(distinct(as_tibble(sample.in.row$.egoID))))
    sample.odegree0<-(nrow(sample.alter)-nrow(sample.in.row))+(nrow(sample.ego)-nrow(distinct(as_tibble(sample.out.row$.egoID))))
    ...
    fit.sample<-ergm(ucnet.sample.network~
                     ...
                     target.stats=c(sample.edges,sample.nodeifactor.male,sample.nodeofactor.male,sample.Reciprocal,sample.f.edges,sample.f.nodeocov,sample.f.nodeocov,sample.nodeocov,sample.nodeicov))
    ...
    ## The log-likelihood improved by 2.0390.

    ## Estimating equations are not within tolerance region.

    ## Iteration 2 of at most 60:

    ## Optimizing with step length 0.0217.

    ## The log-likelihood improved by 2.2679.
    ...
    ## The log-likelihood improved by 1.4712.
    ...
    ## The log-likelihood improved by 1.8686.
    ...
    ## The log-likelihood improved by 2.5236.
    ...
    ## The log-likelihood improved by 1.9416.
    ...
    ## The log-likelihood improved by 2.0313.
    ...
    ## The log-likelihood improved by 1.6339.
    ...
    ## The log-likelihood improved by 1.4388.
    ...
    ## The log-likelihood improved by 2.0129.
    ...
    ## The log-likelihood improved by 2.2392.
    ...
    ## The log-likelihood improved by 1.9268.
    ...
    ## The log-likelihood improved by 1.5376.
    ...
    ## The log-likelihood improved by 1.7072.
    ...
    ## The log-likelihood improved by 2.6496.
    ...
    ## The log-likelihood improved by 1.8514.
    ...
    ## The log-likelihood improved by 1.6514.
    ...
    ## The log-likelihood improved by 1.8957.
    ...
    ## The log-likelihood improved by 1.3401.
    ...
    ## The log-likelihood improved by 2.1897.
    ...
    ## The log-likelihood improved by 2.5681.
    ...
    ## The log-likelihood improved by 2.4412.
    ...
    ## The log-likelihood improved by 1.9278.
    ...
    ## The log-likelihood improved by 2.4840.
    ...
    ## The log-likelihood improved by 1.7146.
    ...
    ## The log-likelihood improved by 1.7438.
    ...
    ## The log-likelihood improved by 1.7984.
    ...
    ## The log-likelihood improved by 2.3535.
    ...
    ## The log-likelihood improved by 1.5681.
    ...
    ## The log-likelihood improved by 1.7136.
    ...
    ## The log-likelihood improved by 2.0226.
    ...
    ## The log-likelihood improved by 2.3026.
    ...
    ## The log-likelihood improved by 1.9559.
    ...
    ## The log-likelihood improved by 1.9517.
    ...
    ## The log-likelihood improved by 1.6646.
    ...
    ## The log-likelihood improved by 2.5321.
    ...
    ## The log-likelihood improved by 1.5036.
    ...
    ## The log-likelihood improved by 1.5410.
    ...
    ## The log-likelihood improved by 1.7196.
    ...
    ## The log-likelihood improved by 2.1088.
    ...
    ## The log-likelihood improved by 1.6660.
    ...
    ## The log-likelihood improved by 1.2452.
    ...
    ## The log-likelihood improved by 1.3230.
    ...
    ## The log-likelihood improved by 2.2721.
    ...
    ## The log-likelihood improved by 2.3159.
    ...
    ## The log-likelihood improved by 1.6608.
    ...
    ## The log-likelihood improved by 1.6813.
    ...
    ## The log-likelihood improved by 1.8737.
    ...
    ## The log-likelihood improved by 1.2121.
    ...
    ## The log-likelihood improved by 1.5090.

    ## Estimating equations are not within tolerance region.

    ## Iteration 55 of at most 60:

    ## Optimizing with step length 0.0060.

    ## The log-likelihood improved by 1.9698.
    ...
    ## The log-likelihood improved by 2.1728.
    ...
    ## The log-likelihood improved by 1.8339.
    ...
    ## The log-likelihood improved by 2.4326.
    ...
    ## The log-likelihood improved by 1.9142.
    ...
    ##     nodeofactor("GENDER") + mutual + F(~edges + nodeocov("Age") + 
    ##     nodeicov("Age"), ~diff("Age") > 6) + nodeocov("Age") + nodeicov("Age") + 
    ##     offset(edges) + offset(mutual), offset.coef = c(-log(550), 
    ##     log(550)), target.stats = c(sample.edges, sample.nodeifactor.male, 
    ##     sample.nodeofactor.male, sample.Reciprocal, sample.f.edges, 
    ##     sample.f.nodeocov, sample.f.nodeocov, sample.nodeocov, sample.nodeicov))
    ## 
    ## Monte Carlo Maximum Likelihood Results:
    ## 
    ##                               Estimate Std. Error MCMC % z value Pr(>|z|)    
    ## edges                          5.33740    0.15921      0   33.52   <1e-04 ***
    ## nodeifactor.GENDER.2          -1.99362    0.05493      1  -36.29   <1e-04 ***
    ## nodeofactor.GENDER.2          -1.93768    0.05274      1  -36.74   <1e-04 ***
    ## mutual                         4.38424    0.29588      0   14.82   <1e-04 ***
    ## F.diff..Age...6..edges        -1.75632    0.78767      0   -2.23   0.0258 *  
    ## F.diff..Age...6..nodeocov.Age -1.36687    0.03487      0  -39.20   <1e-04 ***
    ## F.diff..Age...6..nodeicov.Age  1.48863    0.03838      0   38.78   <1e-04 ***
    ## nodeocov.Age                   1.33983    0.03252      0   41.20   <1e-04 ***
    ## nodeicov.Age                  -1.49406    0.03455      0  -43.24   <1e-04 ***
    ## edges.1                       -6.30992    0.00000      0    -Inf   <1e-04 ***
    ## mutual.1                       6.30992    0.00000      0     Inf   <1e-04 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ##      Null Deviance:   407995  on 294306  degrees of freedom
    ##  Residual Deviance: -2725960  on 294295  degrees of freedom
    ##  
    ## AIC: -2725942  BIC: -2725847  (Smaller is better. MC Std. Err. = 63.54)
    ## 
    ##  The following terms are fixed by offset and are not estimated:
    ##   edges.1 mutual.1

\#Second, we will draw 10 independent egocentric sampled size 550,which
is half of the size of the complete network
...
![](project_files/figure-markdown_strict/unnamed-chunk-17-1.png)
